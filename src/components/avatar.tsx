...
return(
    ...
    <div style={{ width: '100%'}}>
      ...
      <form action="/telegram-webApp/profile"> <p id="name">your name <input defaultValue='' name='name' type="text" placeholder="fren" style={{borderBottomColor:' white',border:'none', background:'none', borderRadius:'5px'}}/></p>

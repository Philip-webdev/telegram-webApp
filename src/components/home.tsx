...
import './avatar';
import { BsCalendar2, BsCalendarPlus, BsCart2, BsCart3, BsFillWalletFill, BsGear, BsGem, BsHeart, BsMinecart, BsPlus, BsPlus, BsStack, BsStackOverflow, BsStarFill, BsStars, BsWallet, BsWallet2, BsWalletFill} from 'react-icons/bs';

...
<div className="items" style={{borderRadius:'5px',margin:'6px',  height: '20px', width: '20px', backgroundColor: '#e8e8e8'}}><img style={{margin:'5.5px', zoom:'70%'}} height='17px' width='17px' src=' https://ouch-cdn2.icons8.com/4E_6STmrlhph_nKBUI8Tv5Pr9TGiE74C4w6cB3Pzh3w/rs:fit:368:317/czM6Ly9pY29uczgu/b3VjaC1wcm9kLmFz/c2V0cy9zdmcvNjAx/LzZiMGUyMGMzLTIy/MTEtNDg0OS05MDMy/LTUxNWZjMjljMTQ1/My5zdmc.png'/><div style={{display:'flex',zoom:'50%'}}><BsHeart style={{zoom:'50%', color:'black', margin:'1px'}}/> <BsPlusCircle style={{zoom:'50%', margin:'1px',color:'black'}}/></div></div>
<div className="items" style={{borderRadius:'5px', margin:'6px', height: '20px', width: '20px', backgroundColor: '#e8e8e8'}}><img style={{margin:'5.5px', zoom:'70%'}} height='17px' width='17px' src=' https://ouch-cdn2.icons8.com/4w-wbnJaspImr0-rImGetVrt_UGrTVPKkYj_GdWx6VU/rs:fit:368:484/czM6Ly9pY29uczgu/b3VjaC1wcm9kLmFz/c2V0cy9wbmcvOTUz/LzM4MmFlMGRhLTlj/OGYtNDcwNy1iZDAz/LWQyOTJlZDc3M2Yw/NC5wbmc.png'/><div style={{display:'flex',zoom:'50%'}}><BsHeart style={{zoom:'50%', color:'black', margin:'1px'}}/> <BsPlusCircle style={{zoom:'50%', margin:'1px',color:'black'}}/></div></div>
</section>
<section style={{display:'flex', zoom:'330%'}}>
...
<div className="items" style={{borderRadius:'5px',margin:'6px', height: '20px', width: '20px', backgroundColor: '#e8e8e8'}}>
    ...
    <div style={{display:'flex',zoom:'50%'}}>
...
<div className="items" style={{borderRadius:'5px', margin:'6px', height: '20px', width: '20px', backgroundColor: '#e8e8e8'}}>
    ...
    <div style={{display:'flex',zoom:'50%'}}><BsHeart style={{zoom:'50%', color:'black', margin:'1px'}}/> <BsPlusCircle style={{zoom:'50%', margin:'1px',color:'black'}}/>
    </div>
    </div>
    </section>
    </div>
